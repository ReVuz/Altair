...
import WinnersPopup from '../Winners/Popup';
import './style.css';
...
const PrizeSection = () => {
  ...
  return (
    <div className="w-full py-16 md:py-32 relative overflow-hidden">
      <div className="max-w-[1600px] mx-auto relative px-4">
        ...
        <div className="flex justify-center mb-12">
          <button
            ...
            onClick={openPopup}
            aria-label="Check Winners"
          >
            <span className="sr-only">Check Winners</span>
          </button>
        </div>
      ...
      {/* Winners Popup with AnimatePresence for proper animations */}
      <AnimatePresence>
        {isPopupOpen && <WinnersPopup onClose={closePopup} />}
      </AnimatePresence>
    </div>
  );
};
